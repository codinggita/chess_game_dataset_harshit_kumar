...
exports.getTotalMatches = async (req, res, next) => {
  try {
...
exports.getTopOpenings = async (req, res, next) => {
  try {
    const data = await Match.aggregate([
...
exports.getWhiteWinRate = async (req, res, next) => {
  try {
...
exports.getBlackWinRate = async (req, res, next) => {
  try {
...
exports.getDrawRate = async (req, res, next) => {
  try {
